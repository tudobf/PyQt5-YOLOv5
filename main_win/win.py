...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(1143, 596)
        mainWindow.setMouseTracking(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/icon/fire.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-image: url(:/img/icon/background1.jpg);\n"
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/img/icon/摄像头开.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/实时视频流解析.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rtspButton.setIcon(icon8)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "YOLOv5检测"))
